...
output_directory='run_nov_2017'            #specify output directory of frames and movies under "results/"

# --------------------------- mode 0 settings

                                   # in real time mode, start time is always now in UTC
past_hours      =  1               # in real time mode, start time with previous hours
future_hours    =  2              # in real time mode, number of hours into future
