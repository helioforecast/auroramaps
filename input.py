...
output_directory='aurora_test_package'            #specify output directory of frames and movies under "results/"
...
future_hours    =  12               # in real time mode, number of hours into future, 0 for one frame only
