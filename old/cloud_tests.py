...
# 
# 
# https://portale.geosphere.at/hpEU/index.php?p=HP_IR_EUPOL16x9&gl=DE
# how to get?
# 
# this would be the minimal nowcast product, with the same representation + aurora oval from OP10 or OP13
# 
# for forecasts, better to use ICON for higher resolution if possible, AROME too narrow, or ECMWF for wider view
# 
# ---------
# ### Installation
# 
...
if region == 'global':  
    view_latitude=60
    view_longitude=-40
    plot_pos=[0.05,0.05,0.9,0.9]  #[left, bottom, width, height]
...
# ## ICON with regridding
# 

# In[ ]:


#ICON example for conversion


#(1) with cdo in command line
...
#converted file to lat lon grid
...
os.system('cdo remapcon,r720x360 -setgrid,'+filegrid+' '+fileicon+' '+fileiconc)
...
# Basic remapping to a regular lat-lon grid
#cdo remapcon,targetgrid.txt icon_data.nc latlon_data.nc

# Create a standard global 0.25° grid definition file
#cdo griddes -setgrid,r720x360 dummy.nc > targetgrid.txt

# OR specify the grid directly
#cdo remapcon,r720x360 icon_data.nc latlon_data.nc


#cdo remapcon,r720x360 -setgrid,icon_grid_0026_R03B07_G.nc icon_test.grib2 output_latlon.grib2

#(2) with eccodes definition files
